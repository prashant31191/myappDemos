...
public class MainActivity extends Activity {
	...
	// https://www.youtube.com/channel/UCg4pOQ8gi4WiK-eJIlb6YBQ
	
	
	// help link -http://stackoverflow.com/questions/18953499/youtube-api-to-fetch-all-videos-on-a-channel 
	
	//https://www.googleapis.com/youtube/v3/search?key={your_key_here}&channelId={channel_id_here}&part=snippet,id&order=date&maxResults=20
	
	//http://www.youtube.com/watch?v={video_id_here}
	String feedUrl  = "https://www.googleapis.com/youtube/v3/search?key=AIzaSyBpeuM22TeZMrqw8hbf3R0D5RBzqcQuP8Q&channelId=UCg4pOQ8gi4WiK-eJIlb6YBQ&part=snippet,id&order=date&maxResults=20";
			...
			*/
			...
			//--	JSONObject data = json.getJSONObject("data");
				...
				//	String title = video.getString("title");
					...
					//videoArrayList.add(video.getString("etag"));
					
					
					JSONObject data2= video.getJSONObject("snippet");
					
					String items2 = data2.getString("title");
					
					System.out.println("=====items2000==="+items2);
					
					videoArrayList.add(items2);
